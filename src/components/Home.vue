  ...
  <el-container class="home-container">
    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '64px' : '200px'">
          ...
          <!-- 侧边栏菜单区域 -->
          <el-menu :default-active="activePath" :router="true" :unique-opened="true"  :collapse-transition='false' :collapse="isCollapse" background-color="#333744" text-color="#fff" active-text-color="#409eef">
          <!-- 一级菜单 -->
